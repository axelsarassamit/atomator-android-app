class Commands {
  ...
  static String sendMessage(String title, String body) => 'wall "' + title + ': ' + body + '" 2>/dev/null; DISPLAY=:0 zenity --info --title="' + title + '" --text="' + body + '" --timeout=30 2>/dev/null; DISPLAY=:0 notify-send "' + title + '" "' + body + '" 2>/dev/null; echo MESSAGE SENT';
